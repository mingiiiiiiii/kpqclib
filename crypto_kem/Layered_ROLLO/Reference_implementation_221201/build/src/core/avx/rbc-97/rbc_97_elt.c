/**
 * \file rbc_97_elt.c
 * \brief Implementation of rbc_97_elt.h
 */

#include "rbc_97.h"
#include "rbc_97_elt.h"

static uint8_t rbc_97_init_field = 0;
uint64_t RBC_97_SQR_LOOKUP_TABLE[256];

/**
 * \fn void rbc_97_field_init()
...
void rbc_97_field_init() {
  ...
  if(rbc_97_init_field == 0) {
    memset(RBC_97_SQR_LOOKUP_TABLE, 0, 8 * 256);
    for(size_t i = 0 ; i < 256 ; ++i) {
      for(size_t j = 0 ; j < 8 ; ++j) {
        mask = 1 << j;
        bit = (mask & i) >> j;
        RBC_97_SQR_LOOKUP_TABLE[i] ^= bit << (2 * j);
      }
    }
...
/**
 * \fn void rbc_97_elt_set_zero(rbc_97_elt o)
 * \brief This function sets a finite field element to zero.
 *
 * \param[out] o rbc_97_elt
 */
void rbc_97_elt_set_zero(rbc_97_elt o) {
  for(uint8_t i = 0 ; i < RBC_97_ELT_SIZE ; i++) {
    o[i] = 0;
  }
}
...
/**
 * \fn void rbc_97_elt_set_one(rbc_97_elt o)
...
void rbc_97_elt_set_one(rbc_97_elt o) {
  o[0] = 1;
  for(uint8_t i = 1 ; i < RBC_97_ELT_SIZE ; i++) {
    o[i] = 0;
  }
}
...
/**
 * \fn void rbc_97_elt_set(rbc_97_elt o, const rbc_97_elt e)
 * \brief This function copies a finite field element into another one.
 *
 * \param[out] o rbc_97_elt
 * \param[in] e rbc_97_elt
 */
...
/**
* \fn void rbc_97_elt_set_mask1(rbc_97_elt o, const rbc_97_elt e1, const rbc_97_elt e2, uint32_t mask)
* \brief This function copies either e1 or e2 into o depending on the mask value
*
* \param[out] o rbc_97_elt
* \param[in] e1 rbc_97_elt
* \param[in] e2 rbc_97_elt_n* \param[in] mask 1 to copy e1 and 0 to copy e2
*/
...
/**
 * \fn void rbc_97_elt_set(rbc_97_elt o1, rbc_97_elt o2, const rbc_97_elt e, uint32_t mask)
 * \brief This function copies e either into o1 or o2 depending on the mask value
 *
 * \param[out] o1 rbc_97_elt
 * \param[out] o2 rbc_97_elt
 * \param[in] e rbc_97_elt
...
/**
 * \fn void rbc_97_elt_set_from_uint64(rbc_97_elt o, uint64_t* rbc_97_elt e)
...
/**
 * \fn uint8_t rbc_97_elt_is_zero(const rbc_97_elt e)
...
uint8_t rbc_97_elt_is_zero(const rbc_97_elt e) {
  int8_t result = 1;
  for(int i = RBC_97_ELT_DATA_SIZE - 1; i >= 0 ; i--) {
    result &= (e[i] == 0);
  }
  return result;
}
...
/**
 * \fn uint8_t rbc_97_elt_is_equal_to(const rbc_97_elt e1, const rbc_97_elt e2)
 * \brief This functions tests if two finite field elements are equal.
 *
 * \param[in] e1 rbc_97_elt
 * \param[in] e2 rbc_97_elt
...
uint8_t rbc_97_elt_is_equal_to(const rbc_97_elt e1, const rbc_97_elt e2) {
  ...
  for(uint8_t i = 0 ; i < RBC_97_ELT_DATA_SIZE ; i++) {
    result &= (e1[i] == e2[i]);
  }
...
/**
 * \fn uint8_t rbc_97_elt_is_greater_than(const rbc_97_elt e1, const rbc_97_elt e2)
...
uint8_t rbc_97_elt_is_greater_than(const rbc_97_elt e1, const rbc_97_elt e2) {
  ...
  for(int8_t i = RBC_97_ELT_DATA_SIZE - 1 ; i >= 0 ; i--) {
    tmp = (e1[i] > e2[i]);
...
/**
 * \fn int32_t rbc_97_elt_get_degree(const rbc_97_elt e)
...
/**
 * \fn uint8_t rbc_97_elt_get_coefficient_vartime(const rbc_97_elt e, uint32_t index)
...
/**
 * \fn void rbc_97_elt_set_coefficient_vartime(rbc_97_elt o, uint32_t index, uint64_t bit)
...
/**
 * \fn rbc_97_elt_add(rbc_97_elt o, const rbc_97_elt e1, const rbc_97_elt e2)
...
/**
 * \fn void rbc_97_elt_mul(rbc_97_elt o, const rbc_97_elt e1, const rbc_97_elt e2)
...
void rbc_97_elt_mul(rbc_97_elt o, const rbc_97_elt e1, const rbc_97_elt e2) {
  rbc_97_elt_ur tmp;
  rbc_97_elt_ur_set_zero(tmp);
  rbc_97_elt_ur_mul(tmp, e1, e2);
  rbc_97_elt_reduce(o, tmp);
}



/**
 * \fn rbc_97_elt_inv(rbc_97_elt o, const rbc_97_elt e)
...
void rbc_97_elt_inv(rbc_97_elt o, const rbc_97_elt e) {
  ...
  rbc_97_elt_set(tmp, e);
  for(int i = 0 ; i < (RBC_97_FIELD_M - 2) ; i++) {
    rbc_97_elt_sqr(o, tmp);
    rbc_97_elt_mul(tmp, o, e);
  }
  rbc_97_elt_sqr(o, tmp);
}
...
/**
 * \fn void rbc_97_elt_sqr(rbc_97_elt o, const rbc_97_elt e)
 * \brief This function computes the square of a finite field element.
 *
 * \param[out] o rbc_97_elt equal to \f$ e^{2} \f$
 * \param[in] e rbc_97_elt
 */
void rbc_97_elt_sqr(rbc_97_elt o, const rbc_97_elt e) {
  if(rbc_97_init_field == 0) {
    printf("Call to rbc_97_elt_sqr with uninitialized field\n");
    exit(1);
  }

  rbc_97_elt_ur tmp;
  rbc_97_elt_ur_sqr(tmp, e);
  rbc_97_elt_reduce(o, tmp);
}

/**
 * \fn void rbc_97_elt_nth_root(rbc_97_elt o, const rbc_97_elt e, uint32_t n)
...
void rbc_97_elt_nth_root(rbc_97_elt o, const rbc_97_elt e, uint32_t n) {
  uint32_t exp = n * (RBC_97_FIELD_M - 1) % RBC_97_FIELD_M;
...
/**
 * \fn void rbc_97_elt_reduce(rbc_97_elt o, const rbc_97_elt_ur e)
 * \brief This function reduces a finite field element.
 *
 * \param[out] o rbc_97_elt equal to $ e \pmod f $
 * \param[in] e rbc_97_elt
 */
void rbc_97_elt_reduce(rbc_97_elt o, const rbc_97_elt_ur e) {

  uint64_t tmp = (e[2] >> 27) ^ (e[3] << 37);
  o[1] = e[1] ^ tmp ^ (tmp >> 6);

  tmp = (o[1] >> 33) ^ (e[2] << 31);
  o[0] = e[0] ^ tmp ^ (tmp << 6);

  o[1] &= 0x00000001FFFFFFFF;
}

/**
 * \fn void rbc_97_elt_print(const rbc_97_elt e)
...
/**
 * \fn void rbc_97_elt_ur_set(rbc_97_elt_ur o, const rbc_97_elt_ur e)
...
void rbc_97_elt_ur_set(rbc_97_elt_ur o, const rbc_97_elt_ur e) {
  for(uint8_t i = 0 ; i < RBC_97_ELT_UR_SIZE ; i++) {
    o[i] = e[i];
  }
}
...
/**
 * \fn void rbc_97_elt_ur_set_zero(rbc_97_elt o)
 * \brief This function sets an unreduced finite field element to zero.
 *
 * \param[out] o rbc_97_elt_ur
 */
...
/**
 * \fn void rbc_97_elt_ur_set_from_uint64(rbc_97_elt_ur o, uint64_t* rbc_97_elt e)
...
void rbc_97_elt_ur_set_from_uint64(rbc_97_elt_ur o, const uint64_t* e) {
  rbc_97_elt_ur_set(o, e);
}

/**
 * \fn void rbc_97_elt_ur_mul(rbc_97_elt_ur o, const rbc_97_elt e1, const rbc_97_elt e2)
 * \brief This function computes the unreduced multiplication of two finite field elements.
 *
 * \param[out] o rbc_97_elt equal to \f$ e_1 \times e_2 $
 * \param[in] e1 rbc_97_elt
 * \param[in] e2 rbc_97_elt
 */
...
/**
 * \fn void rbc_97_elt_ur_sqr(rbc_97_elt o, const rbc_97_elt e)
 * \brief This function computes the unreduced square of a finite field element.
 *
 * \param[out] o rbc_97_elt_ur equal to $ e^{2} $
 * \param[in]  e rbc_97_elt
*/
void rbc_97_elt_ur_sqr(rbc_97_elt_ur o, const rbc_97_elt e) {
  ...
  e_l = _mm_and_si128(tmp1, RBC_97_ELT_SQR_MASK_128);
  e_h = _mm_and_si128(_mm_srli_epi64(tmp1, 4), RBC_97_ELT_SQR_MASK_128);

  e_l = _mm_shuffle_epi8(RBC_97_ELT_SQR_LOOKUP_TABLE_128, e_l);
  e_h = _mm_shuffle_epi8(RBC_97_ELT_SQR_LOOKUP_TABLE_128, e_h);
...
/**
 * \fn void rbc_97_elt_ur_print(const rbc_97_elt_ur e)
 * \brief This function displays an unreduced finite field element.
 *
 * \param[in] e rbc_97_elt_ur
 */
